...
# There are LOW Pass Filters(LPS) which use to remove noise from the images
# There are HIGH Pass Filters(HPS) which use to detect and finding edges in an image 
# 
